...
4. Возможность поиска карты по названию и доп.инфе.
5. Возможность получения ссылки на конкретную точку карты.
6. Добавление карт других регионов и фильтрации по ним (по регионам).
