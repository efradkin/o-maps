...
2. Обозначение авторов-составителей всех карт (по возможности).
3. Список-рейтинг авторов-составителей карт.
4. Фильтрация показываемых карт по соревнованиям (ККП, ЯМ, КБН, ММС итд).
5. Возможность поиска по OSM-карте.
6. Возможность поиска карты по названию и доп.инфе.
7. Возможность получения ссылки на конкретную точку карты.
8. Добавление карт других регионов и фильтрации по ним (по регионам).
