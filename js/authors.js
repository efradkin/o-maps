let authors = {
    ...
    MSPN: {
        name: 'Мосьпан Олеся',
        info: 'Олеся Мосьпан - неоднократный призер всероссийских соревнований и Чемпионатов СПб, составитель большого количества карт не только в Санкт-Петербурге и Ленинградской области, но и в других городах. За период с 2007 по 2014 год, параллельно с работой тренером по спортивному ориентированию в ДДЮТ Всеволожского района, она отрисовала больше 20 карт. По её картам проводились Чемпионаты России в Выборге, Пскове и в Балтийске (Калининград), Чемпионат Белоруссии. Кроме того, Олеся - художник и дизайнер.',
    ...
    TLNV_A: { name: 'Тюленев Александр' }, // Валерьевич
