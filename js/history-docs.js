...
/*
    {
        name: 'Буклет-календарь от клуба KUZMOLOVO. Посвящается 50-летию Кузьмоловской школы спортивного ориентирования (КШСО), 85-летию Ленинградского тренера Сергея Николаевича Крылова и 90-летию Кузьмоловского .',
        owner: 'KUZM',
        year: 2025,
