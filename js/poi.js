let poi = [
    ...
    /* --- КЛУБЫ --- */
    {
        ...
        logo: 'abc.webp',
        info: 'По всем вопросам обращаться в отдел по учебно-спортивной работе т. (812) 378-25-11 в рабочие дни с 9.30 до 18.00, обед с 13:00 до 13:30.',
        type: 'CLUB'
    },
    {
        ...
        logo: 'baltbereg.webp',
        info: 'Обучающиеся СШОР неоднократно становились победителями всероссийских и международных соревнований. За время существования СШОР по виду спорта спортивное ориентирование, было подготовлено более 20 мастеров спорта и 2 мастера спорта международного класса. ' +
            'Учебно-тренировочный процесс по спортивному ориентированию проходит на базе образовательных учреждений, в лесо-парковых и парковых зонах Санкт-Петербурга, на базе Кавголово НГУ им. П.Ф. Лесгафта и в манеже им. В.И.Алексеева. ' +
            'Контактный телефон: (812) 308-21-77.',
        type: 'CLUB'
    },
    {
    ...
    },
    {
        ...
        info: 'Клуб спортивного ориентирования .... тех, кто с ним знаком, увлекается, фанатеет, сочувствует, поддерживает, дружит или хотя бы знает что это такое...',
        type: 'CLUB'
    },
    {
