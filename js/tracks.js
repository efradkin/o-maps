let tracks = [
    ...
    {
        name: 'Дорога на Стрисудден',
        info: 'Маяк Стисудден, мыс Стирсудден. История маяка и его судьба. Исторические события, связанные с этой достопримечательностью. Значение объекта для судоходства. Полуостров Рифовый, озеро Зеркальное.',
        link: 'https://школьныйтуризмроссии.рф/routes/detail/?ELEMENT_ID=2589',
        gpx: 'tracks/strisudden_omaps.gpx',
        owner: 'TRZM_RU',
        type: ['WALK']
    },
    {
        name: 'Пулковская обсерватория',
        info: 'Пешеходный познавательный маршрут «БЛИЖЕ К ЗВЕЗДАМ» по территории Парка Пулковской обсерватории.',
        link: 'https://школьныйтуризмроссии.рф/routes/detail/?ELEMENT_ID=1012',
        gpx: 'tracks/pulkovo_observatory_omaps.gpx',
        owner: 'TRZM_RU',
        type: ['WALK']
    },
    {
        name: 'Заповедная Усть-Ижора',
        info: 'Маршрут не выходит за пределы поселка Усть-Ижора и включает в себя следующие объекты показа: Панорама реки Невы, Ладья «Славия», Стелла в честь Невской битвы, Памятник Петру I, Александро-Невская церковь, Памятник-часовня «Милость Божья в Невской битве», Памятник Александру Невскому – защитнику русской земли.',
        link: 'https://школьныйтуризмроссии.рф/routes/detail/?ELEMENT_ID=2584',
        gpx: 'tracks/ust_izhora_omaps.gpx',
        owner: 'TRZM_RU',
        type: ['WALK']
    },
    {
        name: 'Павловск. Маршрут выходного дня для обучающихся нарушением слуха.',
        info: 'Маршрут разработан специально для обучающихся с нарушением слуха. Маршрут может быть адаптирован для обучающихся с ОВЗ и детей-инвалидов различных нозологий, с сохранным интеллектом.',
        link: 'https://школьныйтуризмроссии.рф/routes/detail/?ELEMENT_ID=2072',
        gpx: 'tracks/pavlovsk_ovz_omaps.gpx',
        owner: 'TRZM_RU',
        type: ['WALK']
    },
    {
        name: 'Озеро Щучье- жемчужина Комарово',
        info: 'Школьный образовательный маршрут – «Озеро Щучье- жемчужина Комарово» по территории государственного природного заказника «Щучье озеро».',
        link: 'https://школьныйтуризмроссии.рф/routes/detail/?ELEMENT_ID=513',
        gpx: 'tracks/zelik_schuchje_omaps.gpx',
        owner: 'TRZM_RU',
        type: ['WALK']
    },
    {
        name: '"ПЕНАТЫ" РЕПИНА',
        info: 'Дача, где угощали печеньем из подорожника.',
        link: 'https://школьныйтуризмроссии.рф/routes/detail/?ELEMENT_ID=506',
        gpx: 'tracks/repino_pennaty_omaps.gpx',
        owner: 'TRZM_RU',
        type: ['WALK']
    },
    {
        name: 'Ивангородская крепость',
        info: 'Автостанция Ивангород-Художественный музей-Ивангородская крепость-музей военно-оборонительного зодчества Северо-запада Руси.',
        link: 'https://школьныйтуризмроссии.рф/routes/detail/?ELEMENT_ID=1685',
        gpx: 'tracks/ivangorod_fortress_omaps.gpx',
        owner: 'TRZM_RU',
        type: ['WALK']
    },
    {
