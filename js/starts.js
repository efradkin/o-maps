let starts = {
    ...
    KKP: {
        ...
        logo: 'kkp.jpg',
        info: 'Крупнейшие соревнования по спортивному ориентированию в России.',
        owner: 'NW'
    },
    KS: {
    ...
    YM: {
        ...
        logo: 'ym.jpg',
        info: 'Яркий Мир — традиционные петербургские массовые многодневные соревнования по спортивному ориентированию (обычно июнь), которые в разные годы оформляются как спортивный фестиваль с несколькими стартами и общим зачётом.' +
            'Впервые они прошли в 1998 году, далее были периоды объединения/разведения по месту и времени с другими июньскими многодневками (в т.ч. «Белые Ночи»).',
        page: 'starts'
    },
    GS: {
        short: 'Зелёный Змей',
    ...
    KZNTSVA: {
        ...
        logo: 'kuznetsov.jpg',
        info: 'Многодневные соревнования памяти Сергея Кузнецова проводились в Ленинградской области в 2013-2015гг.',
        page: 'starts'
    },
    VOLKOV_A: {
    ...
    ROGAINE_110: {
        ...
        info: 'Традиционный кубок соревнований по рогейну бегом короткого формата.',
        logo: '110.gif',
        rogaine: true
    },
    GORNY_CROSS: {
        ...
        logo: 'gk.gif',
        info: 'Традиционный кубок соревнований по рогейну различной длительности (от 2 до 24 часов) бегом, на велосипеде или на лыжах.',
    ...
    KKM: {
        ...
        logo: 'kkm.gif',
        info: 'Кубок коротких маршрутов – соревнования, в которых команды за 3 часа должны набрать наибольшее число очков за прохождение по выбору контрольных пунктов (КП) из числа обозначенных на карте. Каждое КП имеет стоимость в очках.',
        rogaine: true,
        owner: 'RYZHOV'
    },
    BA: {
    ...
    MB: {
        short: 'Марш-Бросок',
        name: '<a href="https://kandid.ru/?p=5" style="white-space:nowrap">Марш-Бросок</a>',
        planner: 'BKTV',
        logo: 'mb.jpg',
        rogaine: true,
    ...
    VYBORGSKY_DISTRICT: {
        short: 'Интерактивное ориентирование в Выборгском р-не',
        name: '<a href="https://vk.com/club114454934">Интерактивное ориентирование в Выборгском р-не</a>',
        logo: 'vyborgsky_district.webp',
        info: 'Инакор — интернет активное ориентирование в Выборгском р-не СПб. Многоэтапные, лично-командные соревнования - проходят в виде маршрута (путешествия) по паркам и кварталам Выборгского района и прилегающим к району территориям, с использованием карт спортивного ориентирования и фотографий.'
    },
    RED_SELO_FOTO: {
    ...
    USSR_BULGARIA_1968: {
        ...
        info: 'Ленинградская область, 13-15 сентября 1968 года. <br /> Первые в Советском Союзе  международные соревнования в целом были  проведены  и организованы на хорощем уровне. ' +
    ...
    USSR_FRANCE_ARMY_1975: {
        ...
        info: 'В 1973 году в Спорткоитете МО СССР принято решение включить сборную команду ориентировшиков в традиционные встречи со спортсменами Франции.<br />' +
            ...
            'а также выступление юных ориентировщиков в разных возрастных группах. К радости французов победителем в одном из забегов стал представитель Франции сержант-шеф Дуриув. ' +
            'Ему был вручен памятный Приз московской федерации.<br />Для соревнований первого дня встречи были подготовлены трассы в районе подмосковной станции Турист д. Дьяково. ' +
            'Двенадцатикилометровая дистанция с 12 КП, поставленная опытным начальником дистанции мастером спорта Виктором Алешиным, проходила по сложной холмистой местности с буреломом.<br />' +
            'Второй день соревнований проходил в Ленинграде. Спортсменов разместили в лучшей гостинице города «Ленинград». Состоялась встреча делегации с руководством северной столицы нашей страны. ' +
            'Французским гостям были показаны достопримечательности города. Состоялась экскурсия в Царское село. Ленинград напомнил французам Париж своими проспектами и архитектурой зданий. ' +
            'В сопровождении роты почетного караула ЛВО посетили Мемориальный комплекс защитникам блокадного Ленинграда – Пискаревское кладбище, возложили венок от французской делегации.<br />' +
            'Трасса соревнований была проложена в районе Кавголово. На этот раз наши армейцы выступали вторым составом. На ленинградской трассе французы выступили уверенней. ' +
            'На трассе 12 км с 12 КП победу одержал француз, старшина Сильвестр Жан-Клод. На втором месте – прапорщик Ржеутский Владимир, третью ступеньку занял старший сержант Лозовски Ришар. ' +
    ...
    WEDDING_MSK: {
        short: 'Золотые Кольца',
        name: 'Золотые Кольца',
        logo: 'wedding_msk.gif',
        info: 'Золотые Кольца - традиционные соревнования по спортивному ориентированию в Москве/ТиНАО. Цели — популяризация ориентирования как массового спорта, ' +
            'а также «выявление сильнейших супружеских пар», укрепление спортивных и дружеских связей. Ключевая «фишка» — 2-этапная эстафета с возрастным гандикапом.'
    },
    /* --- МОСКВА --- */
    AERO: {
        short: 'Аэророгейн',
    ...
    NPW: {
        ...
        logo: 'pragulka.gif',
        info: 'Водная приключенческая гонка в Рязанской области на реке Пра.',
        rogaine: true
    },
    /* --- Прочее --- */
    KKK: {
    ...
    VACHSKY: {
        short: 'Вачский азимут',
        name: '<a href="https://vazimut52.ru/">Вачский азимут</a>',
        info: 'Фестиваль спортивного ориентирования "Вачский Азимут" — традиционные соревнования, проводимые в Вачском и Навашинском районах Нижегородской области.<br />' +
            'Спортивным ориентированием в Вачском районе начали заниматься в середине 80-х годов, в том числе на территории района проводились разовые соревнования регионального масштаба. ' +
            'А в конце 90-х годов группа единомышленников при поддержке спортивного клуба "Ровесник" (п. Вача) решила организовать фестиваль по спортивному ориентированию. ' +
            'Первый "Вачский Азимут" состоялся в 2001 году и собрал всего лишь около 50 участников. Тем не менее было принято решение сделать этот фестиваль традиционным и в этом году данные соревнования состоятся уже в 21 раз! ' +
            'Программа соревнований состоит из пяти стартов, которые проходят в течении пяти дней.',
        logo: 'vachsky.webp',
    },
    /* --- ТРЕКИ --- */
    RUTRAIL: {
