let starts = {
    ...
    VYBORGSKY_DISTRICT: {
        ...
        info: '<p>Инакор — интернет активное ориентирование в Выборгском р-не СПб. Многоэтапные, лично-командные соревнования - проходят в виде маршрута (путешествия) по паркам и кварталам Выборгского района и прилегающим к району территориям, с использованием карт спортивного ориентирования и фотографий.'
    },
    RED_SELO_FOTO: {
