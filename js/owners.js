let owners = {
    ...
    CHGRVSKY_V: {
        name: 'По вопросам использования карты обращаться к Виталию Чегаровскому - vitaly-4@mail.ru.'
    },
    CHGRVSKY_Y: {
    ...
    VYBORG: {
        name: '© Карта является собственностью ФСО г.Выборг',
        logo: 'o-vyborg.gif'
    },
    KSLV_VN: {
    ...
    KUZM_CHGRVSKY: {
        name: 'Карта является собственностью клуба КУЗЬМОЛОВО. По вопросам использования карты - +79213300490 (Михаил Чегаровский).',
        logo: 'kjp.gif'
    },
    KUZNTSV_A: {
    ...
    SVCHK: {
        name: 'Карта является собственностью КСО "Сертолово". По вопросам использования карты - 8 921 423 60 46 (Роман Сивачук).',
        logo: 'sertolovo.webp'
    },
    TMKN: {
    ...
    TRZM_RU: {
        short: '1000 маршрутов',
        name: '<a href="https://школьныйтуризмроссии.рф">1000 маршрутов</a>',
        logo: 'progress.gif',
