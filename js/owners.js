let owners = {
    ...
    VST_PRZRSK: {
        name: 'По вопросам использования - клуб <a href="https://vk.com/vesta_priozersk" target="_blank">Веста-Приозерск</a> (И.Скворцова ira-vesta@yandex.ru).'
    },
    WN: {
    ...
    YUVNT: {
        name: 'По вопросам использования обращаться в ДДТиЭ "Ювента".',
        icon: 'yuventa.jpg'
    },
    ZCHNV: {
        name: '© Зачиняев В.А.'
